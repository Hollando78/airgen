...
export function ContextMenu({ x, y, item, onClose, onOpen, onPopOut, onRename, onDelete, onDownload, onEditMarkdown, onCut, onPaste, hasCutItem, isCutItem }: ContextMenuProps) {
    ...
    >
      ...
      {item.type === "document" && onPopOut && (
        <div className="context-menu-item" onClick={() => {
          ...
          Pop Out in Floating Window
        </div>
      )}

      {item.type === "document" && item.documentKind === "structured" && onEditMarkdown && (
        <div className="context-menu-item" onClick={() => {
          onEditMarkdown();
          onClose();
        }}>
      ...
      {item.type === "document" && onCut && (
        <div
          className={`context-menu-item${isCutItem ? " context-menu-item-active" : ""}`}
          onClick={onCut}
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      {hasCutItem && onPaste && (
        <div className="context-menu-item" onClick={onPaste}>
          ...
          {item.type === "folder" ? "Paste Into Folder" : "Paste Here"}
        </div>
      )}
